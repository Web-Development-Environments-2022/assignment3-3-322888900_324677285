...
<div class="container">
  ...
  <b-modal id="new-rec-modal" title="New Recipe"  @ok="submitRecipe">
   ...
   <div class="form-group">
            ...
            <textarea v-model="recipe_name" class="form-control" id="Recipe-text"></textarea>
    </div> 
       <div class="form-group">
            <label for="RecipeName" class="col-form-label">Cooking duration:</label>
            <textarea v-model="duration" class="form-control" id="Recipe-duration"></textarea>
    </div>
    <div class="form-group">
            <label for="ingredients" class="col-form-label">Ingredients:</label>
            <textarea v-model="extendedIngredients" class="form-control" id="Recipe-ingredients"></textarea>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
            ...
            <textarea v-model="image" class="form-control" id="message-text"></textarea>
    </div>  
    <div class="form-group">
    ...
    <div class="form-group">
            ...
            <input type="checkbox" id="checkbox-vegeterian" v-model="isVegetarian">
    </div> 
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea v-model="servings" class="form-control" id="Recipe-servings"></textarea>
    </div> 
  </b-modal>
</div>
</template>
